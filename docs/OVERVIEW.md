...
| 05 LLMs | 7 | `LLMClient`, `tokenize`/`chunk`, `cosine`, `VectorStore` (`embeddingCsv`), semântico, RAG `MRR`, `ECE` | `docs.jsonl` |
| 06 Agentes | 6 | `Tool` JSON Schema, `ReAct`, `Sandbox` compact, `Conversation`, MCP, `evalTraces` | `customers/docs` |
...
- `docs/TEMPLATE-LICAO.md` — template por lab (50)
