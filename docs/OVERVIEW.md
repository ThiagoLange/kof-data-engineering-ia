...
> 51 labs, 11 módulos, 8 datasets, 100% em `kof 0.4.7-beta` (`~/.kof/bin/kof`).
...
bash scripts/run-tests.sh      # fmt + testes (51 suítes, ~90s em 0.4.7)
...
- `docs/LIMITACOES-KOF-0.1.3.md` — migração `0.1.3→0.4.7` (2 gaps mantidos)
